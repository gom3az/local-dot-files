...
//! - Row: `id` = [`crate::content_hash_hex`] of the full cleaned line (Q2,
...
//!   [`crate::keys::KeyOutcome::Toggle`] for pin/unpin (see `keys`).
//!
...
use crate::width::{self, Measured};
use crate::{content_hash_hex, Row, RowId, Tab};
