...
|---|---|---|
| `~/.local/bin/flex-wallpaper.sh` | Wallpaper picker (`flex wallpaper`): file list + kitty-graphics image preview pane; `wallpaper-picker.sh` is a delegating stub | Yes (kitty popup) |
